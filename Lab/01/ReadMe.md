...
6) Скриншот браузера с загруженным виджетом:
![Скриншот работы серверного приложения](./PrtSc/py.png)

7) Скриншот графического интерфейса клиентского приложения:
![Скриншот работы серверного приложения](./PrtSc/C++.png)
