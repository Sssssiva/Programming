...
def BufferToExcel():
    global Buffer
    try:
        book = openpyxl.open(r'C:\Users\ivano\Desktop\Programming\Lab\02\excel\data.xlsx', read_only=False)
    except:
    ...
    book.save(r'C:\Users\ivano\Desktop\Programming\Lab\02\excel\data.xlsx')
    book.close()
